...
A live demo of the project is available at [https://bociljilbab.pages.dev](https://bociljilbab.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bocil jilbab`)
...
1. Fork the [repository](https://github.com/kahokiburn/bociljilbab/fork) on GitHub.
