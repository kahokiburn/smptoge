...
A live demo of the project is available at [https://smptoge.pages.dev](https://smptoge.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `smp toge`)
...
1. Fork the [repository](https://github.com/kahokiburn/smptoge/fork) on GitHub.
