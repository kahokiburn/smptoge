...
A live demo of the project is available at [https://bociltoge.pages.dev](https://bociltoge.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bocil toge`)
...
1. Fork the [repository](https://github.com/kahokiburn/bociltoge/fork) on GitHub.
